...
const Banner = () => {
  ...
  return (
    <>
      <div className="relative overflow-hidden border rounded-2xl mt-8 shadow-lg">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
          <div className="text-center">
            ...
            <p className="mt-3 text-gray-600">
              Stay in the know with insights from the community.
            </p>
            ...
            <div className="mt-10 sm:mt-20 md:w-3/4 mx-auto">
              {tags.slice(0, 10).map((tag) => (
                <a
                  key={tag._id}
                  className="capitalize m-1 py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 cursor-pointer"
                >
                  {tag?.name}
                </a>
              ))}
