...
const Footer = () => {
  return (
    <div>
      <footer className="mt-auto bg-neutral-800 w-full dark:bg-neutral-950">
            ...
            <div className="col-span-full lg:col-span-1 mr-6">
              ...
              >
                ...
                <span className="text-2xl">
                  Thread <span className="text-lime-400">Nexus</span>
                </span>
              </Link>
            </div>
          ...
          <div className="mt-5 sm:mt-12 flex justify-between items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">
                © 2024 Thread Nexus. All rights reserved.
              </p>
            </div>
